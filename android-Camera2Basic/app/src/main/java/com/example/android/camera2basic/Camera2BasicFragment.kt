...
open class Camera2BasicFragment : Fragment(), View.OnClickListener,
    ...
    open fun onReceivedPreviewImage(bitmap: Bitmap) {
    }
    ...
    private val captureCallback = object : CameraCaptureSession.CaptureCallback() {
        ...
        private fun process(result: CaptureResult) {
            when (state) {
                STATE_PREVIEW -> textureView.bitmap?.let {
                    onReceivedPreviewImage(it)
                }
    ...
    open fun primaryCameraDirection(): Int {
